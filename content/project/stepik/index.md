...
summary: Я познакомился с операционной системой Linux и её базовыми возможностями. 
date: 2025-05-12
external_link: https://github.com/kirillchubaev/stepik_course
authors:
  - admin
tags:
  - Внешний курс
...
**Я закончил выполнение второго этапа внешнего курса, приступила к третьему этапу.**
...
**Я закончил прохождение внешнего курса и получил сертификат с отличием**
